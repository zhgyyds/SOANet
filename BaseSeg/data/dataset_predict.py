...
class PredictDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #     zoom_image, zoom_factor = ScipyResample.resample_to_size(raw_image, self.cfg.FINE_MODEL.INPUT_SIZE)
        ...
        #     zoom_factor = source_size / np.array(self.cfg.FINE_MODEL.INPUT_SIZE)
        #     zoom_image = clip_and_normalize_mean_std(zoom_image, self.window_level[0], self.window_level[1])
        if not self.cfg.COARSE_MODEL.IS_PREPROCESS:
        ...
        #         'raw_spacing': raw_spacing,
        #         'direction': image_direction,
        #         'fine_input_image': zoom_image,
        #         'fine_zoom_factor': zoom_factor}